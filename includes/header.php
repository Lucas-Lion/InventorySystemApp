...
<div class="container-fluid position-fixed">
    <div class="row">
        <div class="d-flex flex-column justify-content-between col-auto nav-color min-vh-100">
            <div>
                ...
                <ul class="nav nav-pills flex-column mt-2 mt-sm-0" id="menu">
                    <!-- Home -->
                    <li class="nav-item fs-5 mb-3 hover-option pt-2 pb-2">
                    ...
                    <!-- Hardwares -->
                    <li class="nav-item fs-5 mb-3 pt-2 pb-2">
                    ...
                    <!-- Sair -->
                    <li class="nav-item fs-5 hover-option pt-2 pb-2">
